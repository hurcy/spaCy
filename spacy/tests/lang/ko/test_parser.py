...
def test_ko_parser_noun_chunks_standard(en_tokenizer):
...
def test_ko_parser_noun_chunks_coordinated(en_tokenizer):
    # fmt: off
...
def test_ko_parser_noun_chunks_pp_chunks(en_tokenizer):
...
def test_ko_parser_noun_chunks_appositional_modifiers(en_tokenizer):
    # fmt: off
...
def test_ko_parser_noun_chunks_dative(en_tokenizer):
