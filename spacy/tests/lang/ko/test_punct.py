...
def test_ko_tokenizer_handles_only_punct(en_tokenizer, text):
...
def test_ko_tokenizer_splits_open_punct(en_tokenizer, punct, text):
...
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_splits_close_punct(en_tokenizer, punct, text):
...
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_splits_two_diff_open_punct(en_tokenizer, punct, punct_add, text):
...
@pytest.mark.parametrize("punct_add", ["'"])
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_splits_two_diff_close_punct(en_tokenizer, punct, punct_add, text):
...
@pytest.mark.parametrize("punct", PUNCT_OPEN)
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_splits_same_open_punct(en_tokenizer, punct, text):
...
@pytest.mark.parametrize("punct", PUNCT_CLOSE)
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_splits_same_close_punct(en_tokenizer, punct, text):
...
def test_ko_tokenizer_splits_open_appostrophe(en_tokenizer, text):
    tokens = en_tokenizer(text)
    assert len(tokens) == 2
...
@pytest.mark.xfail
@pytest.mark.parametrize("text", ["Hello''"])
def test_ko_tokenizer_splits_double_end_quote(en_tokenizer, text):
    tokens = en_tokenizer(text)
    assert len(tokens) == 2
...
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_splits_open_close_punct(
...
@pytest.mark.parametrize("text", ["Hello"])
def test_ko_tokenizer_two_diff_punct(
